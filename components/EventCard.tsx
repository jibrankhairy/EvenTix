  ...
  const renderQueuePosition = () => {
    ...
    return (
      <div className="flex items-center justify-between p-3 bg-violet-50 rounded-lg border border-violet-100">
        <div className="flex items-center">
          <LoaderCircle className="w-4 h-4 mr-2 animate-spin text-violet-500" />
          <span className="text-violet-700">Queue position</span>
        </div>
        ...
        <div className="flex justify-between items-start">
          <div>
            <div className="flex flex-col items-start gap-2">
              {isEventOwner && (
                <span className="inline-flex items-center gap-1 bg-violet-600/90 text-white px-2 py-1 rounded-full text-xs font-medium">
