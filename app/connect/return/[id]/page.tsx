        ...
        <div className="bg-white rounded-xl shadow-lg overflow-hidden">
          ...
          <div className="p-6">
            <div className="space-y-4">
              ...
              <Link
                href="/seller"
                className="block w-full bg-violet-600 text-white text-center py-3 px-4 rounded-lg font-medium hover:bg-violet-700 transition-colors duration-200 flex items-center justify-center gap-2"
              >
